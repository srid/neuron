...
All notes in a Zettelkasten are linear, [[[atomic]]], with links created between them, enabling a [[[heterarchy]]] to evolve organically, rather than having to preconceive a hierarchy ahead (as is the case with outliners like Workflowy and Dynalist).
